			...
			<Box display="flex" width="100%" md-flex-direction="column">
				...
				>
					...
					<Box
						...
						display="flex"
					>
						<Box width="100% border-box" height="320px" background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?fit=crop&w=750&q=80) 0% 0% /auto repeat scroll padding-box">
							<Icon category="md" icon={MdFace} size="64зч" />
							<Text>
								Into the Wild
							</Text>
			...
			<Box display="flex" width="100%" md-flex-direction="column">
				...
				>
					...
					>
						<Box
							width="100%"
							background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?fit=crop&w=750&q=80) 50% 50%/cover"
							border-radius="12px"
							height="320px"
							padding="0px 20px 0px 20px"
						>
							<Icon category="md" icon={MdFace} />
							<Text text-align="center" text-transform="uppercase" color="#ffffff" font="500 24px sans-serif">
								Into the Wild
							</Text>
